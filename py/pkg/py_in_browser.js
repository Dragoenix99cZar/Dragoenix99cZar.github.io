/* @ts-self-types="./py_in_browser.d.ts" */
 ...
 * @returns {string}
 */
export function run_python(source) {
    let deferred2_0;
    let deferred2_1;
    try {
        ...
        wasm.run_python(retptr, ptr0, len0);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('py_in_browser_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
